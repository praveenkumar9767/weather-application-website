...
// https://api.openweathermap.org/data/2.5/weather?q=delhi&appid=adb8964a87c3a9d7d4d54369d58f093f
...
//     // console.log(url)
    ...
    // .then(function(value){              // value aayegi wo json format
    //     return (value.json())         // promise return
    // })
    // .then(function(pro){
    //     console.log(pro.main.feels_like)
    // })
...
function append(data){
    ...
    // p6.src="https://cdn-icons-png.flaticon.com/128/890/890347.png"
    // p6.innerText
    p6.innerText=`Sunrise : ${data.sys.sunrise}`
    
    let p7=document.createElement("p")
    p7.innerText=`Sunset : ${data.sys.sunset}`
    box.append(h3,p1,p2,p3,p4,p5,p6,p7);
